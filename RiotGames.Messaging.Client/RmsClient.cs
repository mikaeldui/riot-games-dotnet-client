...
public class RmsClient : WampSubscriberClient<RmsTypeCode>
{
    ...
    private static bool _remoteCertificateValidationCallback(object sender, X509Certificate? certificate,
        X509Chain? chain, SslPolicyErrors errors)
    {
        ...
        return privateChain.ChainStatus.Length == 1 &&
    ...
    {
        await ConnectAsync($"wss://127.0.0.1:{_port}/");
    }

    protected override WampMessage<RmsTypeCode> OnMessageReceived(RmsTypeCode messageCode, JsonElement[] elements)
    {
    ...
    {
        return (RmsEventMessage) await base.ReceiveAsync(cancellationToken);
    }
}