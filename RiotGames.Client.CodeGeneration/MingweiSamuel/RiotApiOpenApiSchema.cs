...
internal class RiotApiPathObject : OpenApiPathObject<RiotApiMethodObject, RiotApiPostMethodObject,
    RiotApiPutMethodObject, RiotApiParameterObject,
    RiotApiSchemaObject>
{
    [JsonPropertyName("x-endpoint")] public string? XEndpoint { get; set; }

    [JsonPropertyName("x-platforms-available")]
...
internal class
    RiotApiComponentsObject : OpenApiComponentsObject<RiotApiComponentSchemaObject, RiotApiComponentPropertyObject>
{
