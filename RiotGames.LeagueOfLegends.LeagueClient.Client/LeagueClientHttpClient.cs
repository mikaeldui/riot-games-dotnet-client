...
{
    internal LeagueClientHttpClient(string username, string password, ushort port) : base(
        new LeagueClientHttpClientHandler())
    {
...
internal class LeagueClientHttpClientHandler : HttpClientHandler
{
    ...
    private static bool _serverCertificateCustomValidationCallback(HttpRequestMessage message,
